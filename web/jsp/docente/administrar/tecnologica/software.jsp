<%-- 
    Document   : software
    Created on : 25/05/2015, 08:27:51 AM
    Author     : Manuel
--%>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        <form action="leerSoftware.jsp" method="post" role="form" class="form-horizontal">
                                                                                                       <div align="center">
                                                                                                                       ...
                                                                                                                       <div class="table-responsive">
                                                                                                                           <div align="center">
                                                                                                                               <table class="table">
                                                                                                                                   ...
                                                                                                                                   <tbody class="tablas"> 
                                                                                                                                       <% out.println(session.getAttribute("tablaSoftwares").toString()); %>
                                                                                                                                       <tr>       
                                                                                                                                           <td>
                                                                                                                                           ...
                                                                                                                                           <td>
                                                                                                                                               <div class="row">
                                                                                                                                                    <div class="col-lg-12">
                                                                                                                                                        <input class="form-control" id="nomReal" name="nomReal" placeholder="Sistema para la gestion de pedidos" type="text">
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                           </td>
                                                                                                                                           <td>
                                                                                                                                           ...
                                                                                                                                           <td>
                                                                                                                                               <div class="row">
                                                                                                                                                    <div class="col-lg-12">
                                                                                                                                                        <input class="form-control" id="sitio" name="sitio" placeholder="http://ejemplo.com" type="text">
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                           </td>
                                                                                                                                           <td>
                                                                                                                                               <div class="row">
                                                                                                                                                    <div class="col-lg-12">
                                                                                                                                                        <input class="form-control" id="nomCom" name="nomCom" placeholder="SISGEPED" type="text">
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                           </td>
                                                                                                                                           <td>
                                                                                                                                               <div class="row">
                                                                                                                                                    <div class="col-lg-12">
                                                                                                                                                        <input class="form-control" id="contrato" name="contrato" placeholder="234212" type="number">
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                           </td>
                                                                                                                                           <td>
                                                                                                                                               <div class="row">
                                                                                                                                                    <div class="col-lg-12">
                                                                                                                                                        <input class="form-control" id="registro" name="registro" placeholder="234124" type="number">
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                           </td>
                                                                                                                                           <td>
                                                                                                                               ...
                                                                                                                               <div class="btn-group">
                                                                                                                                   <button class="btn btn-success" id="agregar" name = "requerimiento" value="agregarSoftware-0" type="submit">Agregar Software

<%-- 
    Document   : eventos
    Created on : 25/05/2015, 08:26:40 AM
    Author     : Manuel
--%>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                                       <form action="leerEvento.jsp" method="post" role="form" class="form-horizontal">
                                                                   <div align="center">
                                                                           ...
                                                                           <div class="table-responsive">
                                                                               <div align="center">
                                                                                   <table class="table">
                                                                                       ...
                                                                                       <tbody class="tablas">
                                                                                           <% out.println(session.getAttribute("tablaEventos").toString()); %>
                                                                                           <tr>
                                                                                               <td>
                                                                                                   <div class="row">
                                                                                                   <div class="col-md-12">
                                                                                                       <input class="form-control" id="nombreEvento" name="nombreEvento" placeholder="EISI" type="text">
                                                                                                   </div>
                                                                                                   </div>
                                                                                               </td>
                                                                                               <td>
                                                                                               ...
                                                                                               <td>
                                                                                                   <div class="row">
                                                                                                   <div class="col-md-12">
                                                                                                       <input class="form-control" id="lugar" name="lugar" placeholder="UNAB" type="text">
                                                                                                   </div>
                                                                                                   </div>
                                                                                               </td>
                                                                                               <td>
                                                                                               ...
                                                                                               <td>
                                                                                                   <div class="row">
                                                                                                   <div class="col-md-12">
                                                                                                       <input class="form-control" id="fechaFin" name="fechaFin" placeholder="3/2015" type="text">
                                                                                                   </div>
                                                                                                   </div>
                                                                                               </td>
                                                                                               <td>
                                                                                   ...
                                                                                   <div class="btn-group">
                                                                                       <button class="btn btn-success" id="agregar" name = "requerimiento" value="agregarEvento-0" type="submit">Agregar Evento
